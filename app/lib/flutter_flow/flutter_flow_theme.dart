...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF289DE1);
  late Color secondaryColor = const Color(0xFF14B8A6);
  late Color tertiaryColor = const Color(0xFFF59E0B);
  ...
  late Color darkBaground = Color(0xFF1E293B);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF3B82F6);
  late Color secondaryColor = const Color(0xFF2DD4BF);
  late Color tertiaryColor = const Color(0xFFFBBF24);
  ...
  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color textColor = Color(0xFFE2E8F0);
  late Color darkBaground = Color(0xFF0F172A);
}
